...
public class IsFarFromSpecificTileCondition : MapCondition
{
    private uint _distance;

    public IsFarFromSpecificTileCondition(Vector2Int tile, Vector2Int minPosition, Vector2Int maxPosition, uint distance) : base(new List<Vector2Int>() { tile }, minPosition, maxPosition)
    {
        _distance = distance;
    }
